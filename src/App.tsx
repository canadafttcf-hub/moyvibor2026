...
const PARTIES = [
  ...
  { code: "KR",   name: "Коммунисты России", color: "#991b1b", emoji: "🚩", leader: "Сергей Малинкович", descr: "Радикальные левые. Возврат к плановой экономике и идеям Ленина.", logo: "commun.png" },
  ...
  { code: "ROD",  name: "Партия Родина", color: "#475569", emoji: "⚔️", leader: "Алексей Журавлёв", descr: "Национал-консерватизм. Военная мощь и жёсткий государственный суверенитет.", logo: "rodina.png" },
  ...
  return (
    <div className="app">
      ...
      <div className="glass-card calibration-section">
        <h2 className="calibration-section">🎯 Уточнить результат (веса факторов)</h2>
