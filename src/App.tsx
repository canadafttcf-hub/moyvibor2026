...
const PARTIES = [
  ...
  { code: "KPRF", name: "КПРФ", color: "#dc2626", emoji: "☭", leader: "Геннадий Зюганов", descr: "Левая оппозиция. За национализацию, social'ное равенство и советские стандарты.", logo: "image_cbe32b.jpg" },
