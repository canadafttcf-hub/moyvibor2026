...
const ALL_QUESTIONS: Question[] = [
  ...
  { n:52, sec:"VI", text:"ЛГБТ-пропаганда должна быть запрещена.", detail:"Общественная мораль: необходимы ли законодательные ограничения публичной демонстрации нетрадиционных отношений ради защиты традиционных устоев." },
