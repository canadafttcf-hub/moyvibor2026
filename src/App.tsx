...
const PARTIES: Party[] = [
  ...
  { code: "KR",   name: "Коммунисты России", color: "#b91c1c", logo: "commun.jpg", emoji: "🚩", leader: "Сергей Малинкович", descr: "Радикальные левые. Возврат к плановой экономике и идеям Ленина." },
  ...
  { code: "ROD",  name: "Партия Родина", color: "#475569", logo: "rodina.jpg", emoji: "⚔️", leader: "Алексей Журавлёв", descr: "Национал-консерватизм. Военная мощь и жёсткий государственный суверенитет." },
  { code: "PPD",  name: "Партия прямой демократии", color: "#0284c7", logo: "ppd.jpg", emoji: "📱", leader: "Олег Артамонов", descr: "Технократия. Цифровое управление, электронное голосование и блокчейн-демократия." },
